...
nyc_emblem = File.open('app/assets/images/NYC.jpeg')
nyc.emblem.attach(io: nyc_emblem, filename: 'NYC.jpeg')

sf_emblem = File.open('app/assets/images/sanfran.jpeg')
sf.emblem.attach(io: sf_emblem, filename: 'sanfran.jpeg')

tj_logo = File.open('app/assets/images/tjs_logo.png')
tjs.emblem.attach(io: tj_logo, filename: 'tjs_logo.png')
